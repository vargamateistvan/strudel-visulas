...
const VIZ_MODES: { key: VizMode; label: string; desc: string }[] = [
  { key: 'particles', label: 'Particles',  desc: 'Audio-reactive particle field' },
        ...
        <div style={{ padding: '16px 16px 24px', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <section>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <input
                type="range" min={0} max={100} value={Math.round(editorOpacity * 100)}
