        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Live coding + reactive visuals
              </span>
            </div>
          </div>

          <div style={groupStyle}>
            <span style={groupTitleStyle}>Transport</span>
            <span
              style={{
                padding: "4px 8px",
                borderRadius: 999,
          ...
          <div style={groupStyle}>
            <span style={groupTitleStyle}>Library</span>
            <button
          ...
          <div style={groupStyle}>
            <span style={groupTitleStyle}>Capture</span>
            <select
              value={recordingMode}
