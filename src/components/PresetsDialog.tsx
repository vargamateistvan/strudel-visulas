    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: '0 24px 60px rgba(0,0,0,0.45), 0 0 36px rgba(0,255,136,0.16)',
          display: 'flex',
      ...
      >
        ...
        >
          <div style={{ fontFamily: '"JetBrains Mono",monospace', fontWeight: 700, letterSpacing: 2, color: '#00ff88', fontSize: 12 }}>
            PRESETS
          </div>
          <div style={{ color: '#667', fontSize: 12 }}>{presets.length} saved</div>
          <button
            onClick={onClose}
            style={{
              marginLeft: 'auto',
        ...
        <div style={{ padding: '0 16px 16px', overflowY: 'auto' }}>
          {filtered.length === 0 ? (
            <div style={{ color: '#667', fontSize: 12, textAlign: 'center', padding: 24 }}>No presets found.</div>
          ) : (
            filtered.map((preset) => (
              <div
                key={preset.id}
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  {editingId === preset.id ? (
                    ...
                    <div style={{ color: '#d8ffe8', fontFamily: '"JetBrains Mono",monospace', fontSize: 12, fontWeight: 700 }}>
                      {preset.name}
                    </div>
                  )}
                ...
                <div style={{ color: '#63707d', fontSize: 10, marginTop: 6, fontFamily: '"JetBrains Mono",monospace' }}>
